                                        ...
                                        ?>
                                            <tr class="text-center">
                                                ...
                                                <th class="text-center">
                                                    <a href="user_view.php?id=<?php echo $result['UserID']; ?>" class="btn btn-primary fa fa-eye"></a>
                                                    <a href="hapus_user.php?id=<?php echo $result['UserID']; ?>" class="btn btn-danger fa fa-trash" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['Username']; ?>?');"></a>
                                                    <a href="user_Edit.php?id=<?php echo $result['UserID']; ?>" class="btn btn-warning fa fa-edit">
                                                    </a>
                                                </th>
                                            </tr> <?php
                                                } ?>
