                        ...
                        <div class="col-sm-12">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        <h2 class="mb-2 page-title">Data Kategoris</h2>
                                        <div class="row my-4">
                                            <!-- Small table -->
                                            <div class="col-md-12">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <th>
                                                                            <a href="kategori_view.php?id=<?php echo $result['KategoriID']; ?>" class="btn btn-primary fa fa-eye"></a>
                                                                            <a href="hapus_kategori.php?id=<?php echo $result['KategoriID']; ?>" class="btn btn-danger fa fa-trash" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['NamaKategori']; ?>?');"></a>
                                                                            <a href="edit_kategori.php?id=<?php echo $result['KategoriID']; ?>" class="btn btn-warning fa fa-edit">
                                                                            </a>
                                                                        </th>
                                                                    </tr>
                                                            </tbody>
